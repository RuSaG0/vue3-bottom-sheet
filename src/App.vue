<template>
    <div class="container pt-5 pb-5">
        ...
        <button class="btn btn-primary" type="button" @click="changeVisibilityBottomSheet(true)">Open bottom sheet</button>
        <vue-bottom-sheet
        ...
        >
            <div class="sheet-content">
                ...
                <button type="button" class="btn btn-danger" @click="changeVisibilityBottomSheet(false)">Close</button>
            </div>
        </vue-bottom-sheet>
    </div>
</template>
...
const changeVisibilityBottomSheet = (_isOpen: boolean) => {
    isOpenBottomSheet.value = _isOpen
}
</script>
<style>
.sheet-content {
